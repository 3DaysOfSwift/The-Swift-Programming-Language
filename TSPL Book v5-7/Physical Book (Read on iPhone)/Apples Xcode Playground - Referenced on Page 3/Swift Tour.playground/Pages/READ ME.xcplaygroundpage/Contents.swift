...
//:
//: This Xcode playground was created by  Apple as part of their  [Official Online Swift Book](https://www.3DaysOfSwift.com/Swift-Book) (TSPL) to introduce the Swift programming language.
//:
//: This playground file is no longer in circulation, however Apple does maintain an HTML version as part of their online book found [here](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/guidedtour).
//:
//: -------------------
//:
//: ## Contents
