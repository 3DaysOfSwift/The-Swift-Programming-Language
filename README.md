...
## This Repo
This repository contains the conversion of TSPL Book into an Xcode playground. Enjoy!
...
Apple's official book was originally published as a physical hardback book. From version 5.7 this book has been discontinued and will no longer be supported on the iBook Store. 

Swift.org uses the book as online documentation also known as the "language reference guide".

This repo contains the code from the book as an Xcode playground with one playground page for each of the 29 chapters in the book describing the Swift programming language and how to use it.

Download the [Xcode Playground Version](https://www.3DaysOfSwift.com) at [3DaysOfSwift.com](https://www.3DaysOfSwift.com).


## Official Book Contents
Apple created [TSPL](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/thebasics) to discuss and describe the following language features.
