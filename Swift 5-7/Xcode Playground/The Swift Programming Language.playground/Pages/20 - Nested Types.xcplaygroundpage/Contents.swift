...
//: To view original source documentation [click here - Nested Types](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/nestedtypes)
//:
//: -------------------
//:
