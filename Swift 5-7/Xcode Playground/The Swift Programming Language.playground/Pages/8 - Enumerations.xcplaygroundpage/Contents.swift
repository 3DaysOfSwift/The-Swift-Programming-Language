...
//: To view original source documentation [click here - Enumerations](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/enumerations)
//:
//: -------------------
//:
