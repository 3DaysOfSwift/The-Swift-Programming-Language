...
//: To view original source documentation [click here - Type Casting](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/typecasting)
//:
//: -------------------
//:
