...
//: To view original source documentation [click here - Memory Safety](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/memorysafety)
//:
//: -------------------
//:
