...
//: To view original source documentation [click here - Opaque Types](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/opaquetypes)
//:
//: -------------------
//:
