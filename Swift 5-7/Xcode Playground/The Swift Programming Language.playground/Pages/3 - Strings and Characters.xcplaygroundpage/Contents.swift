...
//: To view original source documentation [click here - Strings and Characters](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/stringsandcharacters)
//:
//: -------------------
//:
